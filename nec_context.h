...
enum excitation_return {
	FREQ_PRINT_NORMALIZATION = 0, FREQ_LOOP_CONTINUE = 1,
...
public:
	...
	inline void set_output(nec_output_file in_output,
		nec_output_flags in_output_flags) {
		m_output = in_output;
	...
	void wire(int tag_id, int segment_count, nec_float xw1, nec_float yw1,
		nec_float zw1, nec_float xw2, nec_float yw2, nec_float zw2,
		nec_float rad, nec_float rdel, nec_float rrad);

	void sp_card(int ns, nec_float x1, nec_float y1, nec_float z1, nec_float x2,
		nec_float y2, nec_float z2);
	...
	/*! \brief "ld" card, loading parameters
	 ...
	 \endverbatim
	 */
	void ld_card(int itmp1, int itmp2, int itmp3, int itmp4, nec_float tmp1,
		nec_float tmp2, nec_float tmp3);
	 ...
	 */
	void gn_card(int ground_type, int rad_wire_count, nec_float tmp1,
		nec_float tmp2, nec_float tmp3, nec_float tmp4, nec_float tmp5,
		nec_float tmp6);
	...
	void ex_card(enum excitation_type itmp1, int itmp2, int itmp3, int itmp4,
		nec_float tmp1, nec_float tmp2, nec_float tmp3, nec_float tmp4,
	 ...
	 */
	void ex_card(enum excitation_type itmp1, int itmp2, int itmp3, int itmp4,
		int itmp5, nec_float tmp1, nec_float tmp2, nec_float tmp3,
		nec_float tmp4, nec_float tmp5, nec_float tmp6) {
		int itmp45 = 10 * itmp4 + itmp5;
		return this->ex_card(itmp1, itmp2, itmp3, itmp45, tmp1, tmp2, tmp3,
			tmp4, tmp5, tmp6);
	}
	...
	/*! \brief "tl" card, transmission line parameters
	 ...
	 \endverbatim
	 */
	void tl_card(int itmp1, int itmp2, int itmp3, int itmp4, nec_float tmp1,
		nec_float tmp2, nec_float tmp3, nec_float tmp4, nec_float tmp5,
		nec_float tmp6);
	...
	/*! 4: "nt" card, network parameters
	 ...
	 \endverbatim
	 */
	void nt_card(int itmp1, int itmp2, int itmp3, int itmp4, nec_float tmp1,
		nec_float tmp2, nec_float tmp3, nec_float tmp4, nec_float tmp5,
		nec_float tmp6);
	...
	void gd_card(nec_float tmp1, nec_float tmp2, nec_float tmp3,
		nec_float tmp4);
	 ...
	 */
	void rp_card(int calc_mode, int n_theta, int n_phi, int output_format,
		int normalization, int D, int A, nec_float theta0, nec_float phi0,
		nec_float delta_theta, nec_float delta_phi, nec_float radial_distance,
		nec_float gain_norm);
	 ...
	 */
	void ne_card(int itmp1, int itmp2, int itmp3, int itmp4, nec_float tmp1,
		nec_float tmp2, nec_float tmp3, nec_float tmp4, nec_float tmp5,
		nec_float tmp6);
	...
	/*! Near field calculation parameters
	 ...
	 \li If the number of frequencies is not equal to one (as specified by the fr_card() function, then the ne_card() function will call simulate(), causing the interaction matrix to be computed and factored and the structure currents to be computed.
	 */
	void nh_card(int itmp1, int itmp2, int itmp3, int itmp4, nec_float tmp1,
		nec_float tmp2, nec_float tmp3, nec_float tmp4, nec_float tmp5,
		nec_float tmp6);
	 ...
	 */
	void pl_card(const char* ploutput_filename, int itmp1, int itmp2, int itmp3,
		int itmp4);
	...
	// inside this class...
	void gfld(nec_float rho, nec_float phi, nec_float rz, nec_complex *eth,
		nec_complex *epi, nec_complex *erd, bool space_only,
		nec_float in_wavelength);

	void ffld(nec_float thet, nec_float phi, nec_complex *eth, nec_complex *eph,
		nec_float in_wavelength);
...
private:
	 ...
	 */
	void ne_nh_card(int in_nfeh, int itmp1, int itmp2, int itmp3, int itmp4,
		nec_float tmp1, nec_float tmp2, nec_float tmp3, nec_float tmp4,
		nec_float tmp5, nec_float tmp6);

	void print_freq_int_krnl(nec_float f, nec_float lambda, nec_float int_dist,
	...
	enum excitation_return excitation_loop(int in_freq_loop_state, int mhz);
	...
	inline void compute_matrix_ss(int j1, int j2, int im1, int im2,
		complex_array& in_cm, int64_t nrow, int itrp);
	inline void cmsw(int j1, int j2, int i1, int i2, complex_array& in_cm,
		complex_array& cw, int64_t ncw, int64_t nrow, int itrp);
	inline void cmws(int j, int i1, int i2, complex_array& in_cm, int64_t nr,
		complex_array& cw, int64_t nw, int itrp);

	inline void cmww(int j, int i1, int i2, complex_array& in_cm, int64_t nr,
		complex_array& cw, int64_t nw, int itrp);
	void couple(complex_array& cur, nec_float wlam);

	void efld(nec_float xi, nec_float yi, nec_float zi, nec_float ai,
		bool on_source_segment);
	void eksc(nec_float s, nec_float z, nec_float rh, nec_float xk, int ij,
		nec_complex *ezs, nec_complex *ers, nec_complex *ezc, nec_complex *erc,
		nec_complex *ezk, nec_complex *erk);
	void ekscx(nec_float bx, nec_float s, nec_float z, nec_float rhx,
		nec_float xk, int ij, int inx1, int inx2, nec_complex *ezs,
		nec_complex *ers, nec_complex *ezc, nec_complex *erc, nec_complex *ezk,
		nec_complex *erk);
	void etmns(nec_float p1, nec_float p2, nec_float p3, nec_float p4,
		nec_float p5, nec_float p6, nec_float incident_amplitude,
		enum excitation_type excite_type, complex_array& e);
	...
	void gx(nec_float zz, nec_float rh, nec_float xk, nec_complex *gz,
		nec_complex *gzp);
	void gxx(nec_float zz, nec_float rh, nec_float a, nec_float a2,
		nec_float xk, int ira, nec_complex *g1, nec_complex *g1p,
		nec_complex *g2, nec_complex *g2p, nec_complex *g3, nec_complex *gzp);
	void hfk(nec_float el1, nec_float el2, nec_float rhk, nec_float zpkx,
	...
	void intx(nec_float el1, nec_float el2, nec_float b, int ij, nec_float *sgr,
		nec_float *sgi);
	...
	void impedance_print(int in1, int in2, int in3, nec_float fl1,
		nec_float fl2, nec_float fl3, nec_float fl4, nec_float fl5,
		nec_float fl6, const char *ia);
	...
	void solgf(nec_complex *a, nec_complex *b, nec_complex *c, nec_complex *d,
		nec_complex *xy, int *ip, int np, int n1, int n, int mp, int m1, int m,
		int n1c, int n2c, int n2cz);
